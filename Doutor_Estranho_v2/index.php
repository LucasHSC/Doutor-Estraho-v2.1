...
<body>
        ...
        <div class="container d-flex justify-content-between align-items-center">   
            ...
            <nav>
                ...
                <ul class="links-container list-inline">
                    <li> <a href="./index.php" class="list-inline-item">Home</a>
                    </li>
                    <li> <a href="./pages/personagem.php" class="list-inline-item">Personagens</a>
                    </li>
                    <li> <a href="./pages/galeria.php" class="list-inline-item">Galeria</a>
                    </li>
                </ul>
            </nav>     
        </div>
    ...
    <main>
        <div class="content-container">
            ...
            <a href="https://youtu.be/aWzlQ2N6qqg" class="button">
                Assista o trailer &rightarrow;
            </a>
        </div>
